        ...
        <div className="flex-1 overflow-y-auto px-5 pb-4 space-y-3">
          ...
          <label className="flex items-center gap-2.5 cursor-pointer">
            ...
            <span className="text-[12px] font-medium text-slate-600">
              Acepto las <span onClick={() => navigate('/profile/legal/condiciones-abonos', { state: { from: `${location.pathname}${location.search}` } })} className="text-manises-blue font-bold underline cursor-pointer">condiciones del abono</span>
            </span>
          </label>
        </div>
