...
export function NationalCartSummary({
  ...
  return (
    <section className="rounded-[1.55rem] border border-manises-blue/10 bg-white p-4 shadow-sm">
      ...
      {isAtCap && (
        <p className="mt-1.5 rounded-lg bg-amber-50 px-2.5 py-1.5 text-[9px] font-black uppercase tracking-wider text-amber-600">
        ...
        {lines.map((line) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-black text-manises-blue truncate">{line.drawLabel}</p>
      ...
      <div className="mt-4 space-y-2 border-t border-slate-100 pt-3">
        ...
        <div className="flex items-center justify-between px-1 pt-1 border-t border-slate-50">
          <p className="text-[11px] font-black text-manises-blue uppercase tracking-widest">Importe total</p>
