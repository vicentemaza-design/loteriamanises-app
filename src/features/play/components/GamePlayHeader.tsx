...
export function GamePlayHeader({ game, drawTime, onBack, onInfo, titleOverride, exitAriaLabel }: GamePlayHeaderProps) {
  ...
  return (
    <div
      className="fixed top-0 left-0 right-0 z-40 text-white shadow-lg h-[calc(env(safe-area-inset-top,0px)+56px)]"
      style={{ background: `linear-gradient(135deg, ${game.color}, ${game.colorEnd ?? game.color})` }}
    >
      <div className="h-full pt-safe flex flex-col justify-end">
