...
// ============================================================
// Añade una entrada por cada jueves de sorteo con la clave
...
const FALLBACK_FIXTURES: QuinielaFixture[] = QUINIELA_CALENDAR['2026-07-10'];

/**
 * Devuelve los 15 partidos del jueves indicado.
