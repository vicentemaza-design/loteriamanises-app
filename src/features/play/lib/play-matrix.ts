        ...
        reductionSystems: [
          {
            ...
            guaranteeCondition: 'Si la combinación premiada queda contenida dentro de la selección general de números.',
            supportedNumbers: getSupportedNumbersForReducedSystem('euromillones', 'reducida_4'),
          },
          {
            id: 'reducida_3',
            label: 'Reducida al 3',
            ...
            guaranteeCondition: 'Si la combinación premiada queda contenida dentro de la selección general de números.',
            supportedNumbers: getSupportedNumbersForReducedSystem('euromillones', 'reducida_3'),
          },
          {
            id: 'reducida_2',
            label: 'Reducida al 2',
            status: 'implemented',
            guaranteeLabel: 'Mínimo 2',
            guaranteeCondition: 'Si la combinación premiada queda contenida dentro de la selección general de números.',
            supportedNumbers: getSupportedNumbersForReducedSystem('euromillones', 'reducida_2'),
          },
          {
            id: 'reducida_1',
            label: 'Reducida al 1',
            status: 'implemented',
            guaranteeLabel: 'Mínimo 1',
            guaranteeCondition: 'Si la combinación premiada queda contenida dentro de la selección general de números.',
            supportedNumbers: getSupportedNumbersForReducedSystem('euromillones', 'reducida_1'),
          },
        ],
      },
    ],
        ...
        reductionSystems: [
          {
            ...
            guaranteeLabel: 'Mínimo 5',
            guaranteeCondition: 'Si los 6 aciertos están dentro de la selección general.',
            supportedNumbers: getSupportedNumbersForReducedSystem('bonoloto', 'reducida_5'),
          },
          {
            id: 'reducida_4',
            label: 'Reducida al 4',
            ...
            guaranteeLabel: 'Mínimo 4',
            guaranteeCondition: 'Si los 6 aciertos están dentro de la selección general.',
            supportedNumbers: getSupportedNumbersForReducedSystem('bonoloto', 'reducida_4'),
          },
          {
            id: 'reducida_3',
            label: 'Reducida al 3',
            ...
            guaranteeLabel: 'Mínimo 3',
            guaranteeCondition: 'Si los 6 aciertos están dentro de la selección general.',
            supportedNumbers: getSupportedNumbersForReducedSystem('bonoloto', 'reducida_3'),
          },
        ],
      },
    ],
