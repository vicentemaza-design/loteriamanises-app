...
/**
 * Single source of truth for the "Aviso Legal" document body. Rendered by
 * both the public (/legal/aviso) and the authenticated (/profile/legal/aviso)
 * page — each supplies its own header.
 */
