...
/**
 * Single source of truth for the "Política de Privacidad" document body.
 * Rendered by both the public (/legal/privacidad) and the authenticated
 * (/profile/legal/privacidad) page — each supplies its own header.
 */
