...
/**
 * Single source of truth for the "Condiciones de Abonos" document body.
 * Rendered by both the public (/legal/condiciones-abonos) and the
 * authenticated (/profile/legal/condiciones-abonos) page — each supplies
 * its own header.
 */
export function CondicionesAbonosContent() {
  return (
