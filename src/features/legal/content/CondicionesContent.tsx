...
/**
 * Single source of truth for the "Condiciones Generales" document body.
 * Rendered by both the public (/legal/condiciones) and the authenticated
 * (/profile/legal/condiciones) page — each supplies its own header.
 */
export function CondicionesContent() {
  return (
