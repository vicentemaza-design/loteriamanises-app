 ...
 * without a signed-in user. Purely informational (same text as
 * ResponsibleGamingResourcePage.tsx, shared via responsible-gaming-content.ts).
 *
 ...
 * real account and, eventually, real backend enforcement. This page only
 * points a logged-out visitor toward login for that part.
 */
