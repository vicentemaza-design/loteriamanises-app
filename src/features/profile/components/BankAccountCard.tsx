...
import { BankAccountVerificationNotice } from './BankAccountVerificationNotice';
  ...
  ({ account, selected, onSelect }, ref) => {
    ...
    return (
      <div className="space-y-1.5">
        ...
        {/* Fuera del botón a propósito: es información, no un control, y
            meterlo dentro haría pulsable un párrafo largo. */}
