  ...
  return (
    <div className="flex min-h-full flex-col bg-background pb-24">
      ...
      <div className="flex flex-col gap-4 px-4 pt-4">
        <div className="flex items-center justify-between rounded-[1.6rem] bg-[linear-gradient(135deg,#0a4792_0%,#133b73_62%,#1f2937_100%)] p-4 text-white shadow-sm">
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest opacity-60">
              Premios destacados
            </p>
            <p className="mt-1 text-[2rem] font-black tracking-tight">
          ...
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10">
            <Trophy className="h-6 w-6 text-manises-gold" />
          </div>
        </div>
        ...
        <section className="space-y-2.5">
          ...
          <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
            {highlightedPrizes.map((prize) => (
              <div key={prize.id} className="rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm">
                ...
                <p className="mt-2.5 text-[12px] font-black text-emerald-600">
        ...
        <section className="space-y-2.5">
          ...
          <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm divide-y divide-border/50">
            {MOCK_DELIVERED_PRIZES.map((prize) => (
              <div key={prize.id} className="flex items-center gap-3 p-3.5">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-manises-gold/10">
        ...
        <div className="flex gap-3 rounded-2xl border border-border bg-slate-50 p-3.5">
