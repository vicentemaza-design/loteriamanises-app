...
export const LOTTERY_GAMES: LotteryGame[] = [
  {
    ...
    frequency: 'Mar y Vie',
    // Matriz Técnica
    technicalMode: 'multiple',
    systemFamily: 'direct',
    guaranteeType: 'direct_full_coverage',
    selectionRange: { numbers: { min: 5, max: 10 }, stars: { min: 2, max: 5 } },
    productLimit: '252 ap.',
  ...
  },
  {
    ...
    systemFamily: 'direct',
    guaranteeType: 'direct_full_coverage',
    selectionRange: { numbers: { min: 6, max: 6 } },
  ...
  },
  {
    ...
    type: 'quiniela',
    jackpot: 4_700_000,
    nextDraw: nextDate(4, 18, 0),
    color: '#dc2626',
    colorEnd: '#7f1d1d',
    icon: 'Trophy',
    price: 0.75, // Ajustado según Matriz Técnica
    description: 'Fútbol con 1X2',
    frequency: 'Sábados y jornadas',
    // Matriz Técnica
    technicalMode: 'reduced',
    systemFamily: 'official',
    guaranteeType: 'conditional_minimum',
    guaranteeCondition: 'Si se aciertan los 14 resultados, el sistema asegura al menos 1 premio de 13.',
    productLimit: '132 ap.',
    productionPhase1: true,
  },
  {
