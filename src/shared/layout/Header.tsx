...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-manises-blue/80 backdrop-blur-3xl border-b border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
