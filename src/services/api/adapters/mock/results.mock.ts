...
export const MOCK_RESULTS_DATA: ResultDto[] = [
  ...
  // 4. PRIMITIVA (Lunes, 8 de junio de 2026)
  {
    ...
    jokerScrutiny: [
      { category: '1ª (todas las cifras)', winners: 0, prizePerWinner: 1000000 },
      { category: '2ª (6 primeras o últimas cifras)', winners: 1, prizePerWinner: 10000 },
      { category: '3ª (5 primeras o últimas cifras)', winners: 4, prizePerWinner: 1000 },
      { category: '4ª (4 primeras o últimas cifras)', winners: 38, prizePerWinner: 300 },
      { category: '5ª (3 primeras o últimas cifras)', winners: 421, prizePerWinner: 50 },
      { category: '6ª (2 primeras o últimas cifras)', winners: 4190, prizePerWinner: 5 },
      { category: '7ª (1 primera o última cifra)', winners: 41832, prizePerWinner: 1 },
    ],
  },
  ...
  // 5. PRIMITIVA (Sábado, 6 de junio de 2026) - Mapped to Saturday
  {
    ...
    jokerScrutiny: [
      { category: '1ª (todas las cifras)', winners: 0, prizePerWinner: 1000000 },
      { category: '2ª (6 primeras o últimas cifras)', winners: 0, prizePerWinner: 10000 },
      { category: '3ª (5 primeras o últimas cifras)', winners: 7, prizePerWinner: 1000 },
      { category: '4ª (4 primeras o últimas cifras)', winners: 51, prizePerWinner: 300 },
      { category: '5ª (3 primeras o últimas cifras)', winners: 498, prizePerWinner: 50 },
      { category: '6ª (2 primeras o últimas cifras)', winners: 4823, prizePerWinner: 5 },
      { category: '7ª (1 primera o última cifra)', winners: 47210, prizePerWinner: 1 },
    ],
  },
  ...
  },
  {
    ...
    scrutiny: [
      { category: '1ª (6 + Sueño)', winners: 0, prizePerWinner: 20000, isMonthly: true },
      { category: '2ª (6)', winners: 0, prizePerWinner: 5000, isMonthly: true },
      { category: '3ª (5 + Sueño / 5)', winners: 2, prizePerWinner: 2000 },
      { category: '4ª (4 + Sueño / 4)', winners: 87, prizePerWinner: 50 },
      { category: '5ª (3 + Sueño / 3)', winners: 3214, prizePerWinner: 10 },
      { category: '6ª (2 + Sueño / 2)', winners: 89432, prizePerWinner: 4 },
    ],
  },
  // EuroDreams — 13 jul 2026 (demo-eurodreams-won)
  {
    gameId: 'eurodreams',
    gameType: 'eurodreams',
    date: '2026-07-13T21:00:00.000Z',
    numbers: [3, 17, 23, 31, 14, 39],
    stars: [2],
    jackpotNext: 20000,
    nextDrawDate: '2026-07-16T21:00:00.000Z',
    scrutiny: [
      { category: '1ª (6 + Sueño)', winners: 0, prizePerWinner: 20000, isMonthly: true },
      { category: '2ª (6)', winners: 0, prizePerWinner: 5000, isMonthly: true },
      { category: '3ª (5 + Sueño / 5)', winners: 1, prizePerWinner: 2000 },
      { category: '4ª (4 + Sueño / 4)', winners: 103, prizePerWinner: 50 },
      { category: '5ª (3 + Sueño / 3)', winners: 4872, prizePerWinner: 10 },
      { category: '6ª (2 + Sueño / 2)', winners: 97341, prizePerWinner: 4 },
    ],
  },
  {
    gameId: 'quiniela',
  ...
  // Apuesta 1 del ticket: [5,12,21,30,49,6] → acierta 5, 12, 21 (3 aciertos)
  {
    ...
    jokerScrutiny: [
      { category: '1ª (todas las cifras)', winners: 1, prizePerWinner: 1000000 },
      { category: '2ª (6 primeras o últimas cifras)', winners: 2, prizePerWinner: 10000 },
      { category: '3ª (5 primeras o últimas cifras)', winners: 11, prizePerWinner: 1000 },
      { category: '4ª (4 primeras o últimas cifras)', winners: 44, prizePerWinner: 300 },
      { category: '5ª (3 primeras o últimas cifras)', winners: 389, prizePerWinner: 50 },
      { category: '6ª (2 primeras o últimas cifras)', winners: 3921, prizePerWinner: 5 },
      { category: '7ª (1 primera o última cifra)', winners: 39104, prizePerWinner: 1 },
    ],
  },
